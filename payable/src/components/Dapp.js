...
import Vendor from "../contracts/Vendor.json";
...
export class Dapp extends React.Component {
  ...
  async _transferTokens(to, amount) {
    ...
    try {
      ...
      console.log("this._vendor", this._vendor);

      const tx = await this._vendor.buyTokens({value: amount});
  ...
  async _mintNFT(to) {
    try {      
      ...
      const TempProvider = new ethers.getDefaultProvider("rinkeby");
      ...
      const tx = await this._nft.safeMint(to, id+1);
      this.setState({ txBeingSent: tx.hash });
